"""This module provides a BitMask64 class to represent a 64-bit bitmask and
functions to check access permissions based on bitwise operations.
"""


class BitMask64:
    """
    A class to represent a 64-bit bitmask.
    This class allows for the creation of a bitmask from various input types
    such as strings, integers, and bytes. It also provides methods to check
    if access is allowed based on bitwise operations.
    """
